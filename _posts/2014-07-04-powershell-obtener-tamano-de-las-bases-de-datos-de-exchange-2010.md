...
Normalmente estamos preocupados por el tamaño de nuestras bases de datos y mas si son de un servicio tan critico como el correo, debemos saber si estarán llegando al límite, si tengo que dar mas espacio libre, si tengo que hacer una defragmentación. Os propongo este [cmdlet](http://technet.microsoft.com/es-es/library/aa996589.aspx) que en una solua línea nos da la información del tamaño de todas nuestras bases de datos

Simplemente desde la Exchange Management Shell, debemos ejecutar la siguiente linea:

<pre class="lang:ps decode:true ">Get-MailboxDatabase -Status | fl name, databasesize</pre>
