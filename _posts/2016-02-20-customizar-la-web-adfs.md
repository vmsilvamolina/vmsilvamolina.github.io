...
<imagen del sitio conlos nombres de las partes>
...
También es posible agregar un pequeño bloque de texto para que los usuarios puedan leer a modo de información, sugerencias, etc.
    ...
    Set-AdfsGlobalWebContent -SignInPageDescriptionText "<p>Para iniciar sesión en el sitio es necesario contar con un usuario ya creado. Clic <A href='http://intranet.contoso.com/registration/'>aquí</A> para solicitar el alta.</p>"
...
Dentro del sitio se puden habilitar 3 tipos diferentes de enlaces que proporcionan información al usuario, éstos son:
