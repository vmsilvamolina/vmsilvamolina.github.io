...
<div>This blog post is also a contribution to Azure Advent Calendar where during December, experts from the tech community share their knowledge through contributions of a specific technology in the Azure domain. You’re welcome to check out all the contributions here: <a href="">Azure Advent Calendar</a></div>{: .notice--success}
