...
Nos resta aplicar los cambios que realizamos, ya que se encuentran todos dentro de la variable. Para poder aplicarlos debemos ejecutar una simple líne ade código, de la siguiente manera:
